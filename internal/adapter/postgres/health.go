...
func (checker *HealthChecker) Check(ctx context.Context) error {
	...
	err := checker.db.QueryRowContext(ctx, `
		...
		FROM (VALUES
			...
			('managed_external_sell_batches'),
			('managed_external_sells'),
	...
	err = checker.db.QueryRowContext(ctx, `
		...
		FROM (VALUES
			...
			('execution_wallet_migrations', 'migration_id'),
			('execution_wallet_migrations', 'execution_account_id'),
			('execution_wallet_migrations', 'old_wallet_address'),
			('execution_wallet_migrations', 'new_wallet_address'),
			('execution_wallet_migrations', 'chain_id'),
			('execution_wallet_migrations', 'collateral_asset'),
			('execution_wallet_migrations', 'collateral_balance_before'),
			('execution_wallet_migrations', 'collateral_balance_after'),
			('execution_wallet_migrations', 'occurred_at'),
			('execution_wallet_migrations', 'evidence'),
			('execution_wallet_migrations', 'actor'),
			('execution_wallet_migrations', 'reason'),
	...
	err = checker.db.QueryRowContext(ctx, `
		...
		FROM (VALUES
			...
			('execution_wallet_migrations_pkey'),
			('execution_wallet_migrations_execution_account_fk'),
			('execution_wallet_migrations_account_wallets_unique'),
			('execution_wallet_migrations_identity_nonempty'),
			('execution_wallet_migrations_wallet_shape'),
			('execution_wallet_migrations_chain_shape'),
			('execution_wallet_migrations_balance_shape'),
			('execution_wallet_migrations_evidence_object'),
	...
	err = checker.db.QueryRowContext(ctx, `
		...
		FROM (VALUES
			...
			('execution_wallet_migrations_append_only_trigger'),
