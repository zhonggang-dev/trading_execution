...
func TestOrderRepositoryRecoverySelectionPostgresIntegration(t *testing.T) {
	...
	fixtures := []struct {
		...
		{name: "old-active-sell", side: domain.SideSell, status: domain.OrderStatusCancelled, updatedAt: old, reservationStatus: domain.ReservationStatusActive, wantPending: true, wantReconcile: true},
		{name: "old-uncertain-cancelled-buy", side: domain.SideBuy, status: domain.OrderStatusCancelled, updatedAt: old, reservationStatus: domain.ReservationStatusReconciliationRequired, wantPending: true, wantReconcile: true},
		{name: "old-empty-cancelled-sell", side: domain.SideSell, status: domain.OrderStatusCancelled, updatedAt: old, reservationStatus: domain.ReservationStatusActive, emptyReservation: true, wantPending: true},
